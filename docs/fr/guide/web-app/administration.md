...
Que vous ayez connecté votre plateforme à un système d’authentification SSO ou non, vous devez gérer vos utilisateurs depuis l’interface d’administration Cocoom.
...
Si vous êtes en connexion SSO chaque compte utilisateur sera simplement relié à votre base Cocoom et chaque utilisateur pourra directement accéder à Cocoom.

Dans le cas contraire l’utilisateur sera invité à saisir son nom et prénom puis choisir ses identifiants et mot de passe pour créer son compte. Une fois son compte créé, il pourra s’authentifier et accéder à Cocoom.
